    ...
    public static Field[] createFields() { // How to makes an array: type[] variabelName
        return new Field[]{
                ...
                new StartField("START", "Modtag 4000", "Modtag kr. 4000 hver gang du passerer start",
                        Color.RED),
                new PropertyField("Rødovrevej", "Pris: kr. 1200", "Rødovrevej", 50,
                        new Color(0, 0, 102), new Color(255, 255, 255)),
                new ChanceField(),
                new PropertyField("Hvidovrevej", "Pris: kr. 1200", "Hvidovrevej", 50,
                        new Color(0, 0, 102), new Color(255, 255, 255)),
                new TaxField("Betal\nindkomst-\nskat", "10% el. 4000", "Betal indkomstskat\n10% eller kr. 4000,-"),
                new ShippingField("Øresund", "Pris: kr. 4000", "Øresundsredderiet", 500),

                // Index 5-9
                new PropertyField("Roskildevej", "Pris: kr. 2000", "Roskildevej", 100,
                        new Color(255, 128, 0), new Color(0, 0, 0)),
                new ChanceField(),
                new PropertyField("Valby\nLanggade", "Pris: kr. 2000", "Valby Langgade", 100,
                        new Color(255, 128, 0), new Color(0, 0, 0)),
                new PropertyField("Allégade", "Pris: kr. 2400", "Allégade", 150,
                        new Color(255, 128, 0), new Color(0, 0, 0)),

                // Index 10-14
                new JailField("Fængsel", "Fængsel", "På besøg i fængslet"),
                new PropertyField("Frederiks-\nberg Allé", "Pris: kr. 2800", "Frederiksberg Allé", 200,
                        new Color(102, 204, 0), new Color(0, 0, 0)),
                new BreweryField("Tuborg", "Pris: kr. 3000", "Tuborg bryggeri"),
                new PropertyField("Bülowsvej", "Pris: kr. 2800", "Bülowsvej", 200,
                        new Color(102, 204, 0), new Color(0, 0, 0)),
                new PropertyField("Gammel Kongevej", "Pris: kr. 3200", "Gammel Kongevej", 250,
                        new Color(102, 204, 0), new Color(0, 0, 0)),

                // Index 15-19
                new ShippingField("D.F.D.S.", "Pris: kr. 4000", "D.F.D.S.", 500),
                new PropertyField("Bernstorffsvej", "Pris: kr. 3600", "Bernstorffsvej", 300,
                        new Color(96, 96, 96), new Color(0, 0, 0)),
                new ChanceField(),
                new PropertyField("Hellerupvej", "Pris: kr. 3600", "Hellerupvej", 300,
                        new Color(96, 96, 96), new Color(0, 0, 0)),
                new PropertyField("Strandvejen", "Pris: kr. 4000", "Strandvejen", 350,
                ...
                new PropertyField("Bredgade", "Pris: kr. 5200", "Bredgade", 450,
                        new Color(255, 255, 255), new Color(0, 0, 0)),
                new PropertyField("Kgs. Nytorv", "Pris: kr. 5200", "Kongens Nytorv", 450,
                        new Color(255, 255, 255), new Color(0, 0, 0)),
                new BreweryField("Carlsberg", "Pris: kr. 3000", "Carlsberg bryggeri"),
                new PropertyField("Østergade", "Pris: kr. 5600", "Østergade", 500,
                        new Color(255, 255, 255), new Color(0, 0, 0)),

                // Index 30-34
                new GoToJailField("Gå i fængsel", "Gå i fængsel",
                        "Du fængsles\nSlå to ens for at komme ud"),
                new PropertyField("Amagertorv", "Pris: kr. 6000", "Amagertorv", 550,
                        new Color(255, 255, 50), new Color(0, 0, 0)),
                new PropertyField("Vimmel-\nskaftet", "Pris: kr. 6000", "Vimmelskaftet", 550,
                        new Color(255, 255, 50), new Color(0, 0, 0)),
                new ChanceField(),
                new PropertyField("Nygade", "Pris: kr. 6400", "Nygade", 600,
                        new Color(255, 255, 50), new Color(0, 0, 0)),
